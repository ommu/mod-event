<?php
/**
 * BlastingItemController
 * @var ommu\event\controllers\BlastingItemController
 * @var $model ommu\event\models\EventBlastingItem
 *
 * BlastingItemController implements the CRUD actions for EventBlastingItem model.
 * Reference start
 * TOC :
 *	Index
 *	Manage
...
class BlastingItemController extends Controller
{
	/**
	 * @inheritdoc
	 */
