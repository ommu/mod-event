...
/**
 * BlastingsController
 * @var ommu\event\controllers\BlastingsController
 * @var $model ommu\event\models\EventBlastings
 *
 * BlastingsController implements the CRUD actions for EventBlastings model.
 * Reference start
 * TOC :
 *	Index
 *	Manage
...
class BlastingsController extends Controller
{
	/**
	 * @inheritdoc
	 */
