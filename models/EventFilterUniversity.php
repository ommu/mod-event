...
class EventFilterUniversity extends \app\components\ActiveRecord
{
	...
	{
		return [
			[['event_id', 'university_id', 'creation_id'], 'required'],
			...
			[['university_id'], 'exist', 'skipOnError' => true, 'targetClass' => IpediaUniversity::className(), 'targetAttribute' => ['university_id' => 'university_id']],
		];
	}
	...
	{
		return $this->hasOne(IpediaUniversity::className(), ['university_id' => 'university_id']);
	}
	...
	public function attributeLabels()
	{
		return [
			...
			'university_search' => Yii::t('app', 'University'),
	...
	public function init()
	{
		...
		if(!Yii::$app->request->get('university')) {
			$this->templateColumns['university_search'] = [
				'attribute' => 'university_search',
				'value' => function($model, $key, $index, $column) {
					return $model->university->university_id;
				},
			];
		}
