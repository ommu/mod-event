...
$this->params['menu']['content'] = [
	['label' => Yii::t('app', 'Back To Event Blastings'), 'url' => Url::to(['blastings/index']), 'icon' => 'table'],
	['label' => Yii::t('app', 'View Blasting History'), 'url' => Url::to(['blasting-history/index']), 'icon' => 'table'],
];
